const STORAGE_KEY = "bells-greensomes-round";
...
const playerACourseDisplay = document.getElementById("playerACourse");
const playerBCourseDisplay = document.getElementById("playerBCourse");
...
function renderCourse() {
    ...
    courseInfo.innerHTML = `
        ...
        <span>Greensomes: 60% lower + 40% higher</span>
    `;
